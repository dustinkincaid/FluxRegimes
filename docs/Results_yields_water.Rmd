---
title: <font size = "5"> Visualizing all SOM event water yield results </font>
...
### Objective  
##### Visualize results of SOM clustered flux regimes on event water yields from Hungerford and Wade Brooks
<br><br>
...
# Read in data
  ...
  # Water
  som_hf <- read_csv(here("Data", "somResults", "hford", "yields", "water", "2021-04-07", "Results_hford_withClusters.csv"))
  som_wd <- read_csv(here("Data", "somResults", "wade", "yields", "water", "2021-04-07", "Results_wade_withClusters.csv"))
  # NO3
  # som_no3_hf <- read_csv(here("Data", "somResults", "hford", "yields", "NO3", "2021-04-08", "Results_hford_withClusters.csv")) %>% mutate(SOM = "NO3") %>% select(site, SOM, everything())
  # som_no3_wd <- read_csv(here("Data", "somResults", "wade", "yields", "NO3", "2021-04-12", "Results_wade_withClusters.csv")) %>% mutate(SOM = "NO3") %>% select(site, SOM, everything())
  # SRP
