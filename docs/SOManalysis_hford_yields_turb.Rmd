---
title: "Self-organizing map analysis of watershed conditions for event turbidity yields at Hungerford"
...
newFolder <- paste("Data/somResults/hford/yields/turb/", Sys.Date(), sep = "")
...
params <- read_csv(here("Data", "somParams", "params_SOM_hford_turb.csv"))
...
for (i in 1:nrow(params)) {
      ...
      newFolder2 <- paste("Data/somResults/hford/yields/turb/", Sys.Date(), "/SOMplots_PDFs", sep = "")
