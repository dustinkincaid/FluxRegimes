---
title: "Self-organizing map analysis of watershed conditions for event NO3 yields at Hungerford"
...
newFolder <- paste("Data/somResults/hford/yields/NO3/", Sys.Date(), sep = "")
...
# Look at correlations again without dropped variables
  ...
  drop.vars <- names(hford %>% 
                       select(# Remove multipeak for now b/c we have q_4d and time_sinceLastEvent
                              ...
                              DOY,
                              # Remove these vars b/c irrelevant for NO3
                              turb_1d,
                              SRP_1d,
...
params <- read_csv(here("Data", "somParams", "params_SOM_hford_NO3.csv"))
...
for (i in 1:nrow(params)) {
      ...
      newFolder2 <- paste("Data/somResults/hford/yields/NO3/", Sys.Date(), "/SOMplots_PDFs", sep = "")
