---
title: <font size = "5"> Self-organizing map analysis for event water yields at Wade
  </font>
...
newFolder <- paste("Data/somResults/wade/yields/water/", Sys.Date(), sep = "")
...
params <- read_csv(here("Data", "somParams", "params_SOM_wade_water.csv"))
...
for (i in 1:nrow(params)) {
      ...
      newFolder2 <- paste("Data/somResults/wade/yields/water/", Sys.Date(), "/SOMplots_PDFs", sep = "")
...
datWithCluster %>% 
  ...
  mutate(var = factor(var, levels = c("rain_int_mmPERmin_mean", "rain_int_mmPERmin_max", "rain_event_hrs", "rain_event_total_mm",
                                      "q_4d", "time_sinceLastEvent", "API_4d", "VWC_pre_wet_15cm", "VWC_pre_wet_30cm", "VWC_pre_dry_30cm", "VWC_pre_dry_15cm", "SoilTemp_pre_wet_15cm",
