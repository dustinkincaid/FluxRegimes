---
title: <font size = "5"> Self-organizing map analysis for event SRP yields at Wade
  </font>
...
newFolder <- paste("Data/somResults/wade/yields/SRP/", Sys.Date(), sep = "")
...
# Look at correlations again without dropped variables
  ...
  drop.vars <- names(wade %>% 
                       select(# Remove multipeak for now b/c we have q_4d and time_sinceLastEvent
                              ...
                              DOY,
                              # Remove these vars b/c irrelevant for SRP
                              turb_1d,
                              NO3_1d
                              ))
...
params <- read_csv(here("Data", "somParams", "params_SOM_wade_SRP.csv"))
...
for (i in 1:nrow(params)) {
      ...
      newFolder2 <- paste("Data/somResults/wade/yields/SRP/", Sys.Date(), "/SOMplots_PDFs", sep = "")
