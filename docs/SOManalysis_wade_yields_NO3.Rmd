---
title: <font size = "5"> Self-organizing map analysis for event NO3 yields at Wade
  </font>
author: "Dustin Kincaid"
date: "04/12/2021<br><br>"
output:
  html_document:
    df_print: paged
...
newFolder <- paste("Data/somResults/wade/yields/NO3/", Sys.Date(), sep = "")
...
params <- read_csv(here("Data", "somParams", "params_SOM_wade_NO3.csv"))
...
for (i in 1:nrow(params)) {
      ...
      newFolder2 <- paste("Data/somResults/wade/yields/NO3/", Sys.Date(), "/SOMplots_PDFs", sep = "")
