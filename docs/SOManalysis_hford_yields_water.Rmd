---
title: <font size = "5"> Self-organizing map analysis for Hungerford YIELDS </font>
...
1. Event water yields  
2. Event NO3 yields  
3. Event SRP yields  
4. Event NO3:SRP yield ratios  
5. Event turbidity yields  
<br><br>
...
newFolder <- paste("Data/somResults/hford/yields", Sys.Date(), sep = "")
