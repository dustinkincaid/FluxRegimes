...
#Read in the data
var_data = pd.read_csv('/Users/dustinkincaid/ownCloud/BREE/Watershed Data/1_Projects/FluxRegimes/Data/transformed_vars_wade.csv',sep=',')
...
rain_pre_1d = np.asarray(var_data['rain_preEvent_1d'])
...
redox_mean_pre_6 = np.asarray(var_data['Redox_mean_preEvent_6'])
VWC_mean_pre_6 = np.asarray(var_data['VWC_mean_preEvent_6'])
...
for idx, met_var in enumerate([q, NO3, SRP, event_NO3_SRP, time_since_last, rain_total, rain_hrs, rain_int, rain_pre_1d, rain_pre_7d, q_pre_mean_1d, q_event_delta, PET, redox_mean_pre_6, VWC_mean_pre_6]):
